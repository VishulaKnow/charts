...
export class EmbeddedLabels {
	...
	public static update(
		...
		labelsGroup.selectAll<SVGRectElement, MdtChartsDataRow>(`.${this.embeddedLabelBgClass}`).remove();
	...
	private static renderLabel(
		labelsGroup: Selection<SVGGElement, unknown, HTMLElement, unknown>,
		barAttrsHelper: BarAttrsHelper,
	...
	private static updateLabel(
		...
		labelsGroup: Selection<SVGGElement, unknown, SVGGElement, unknown>
	): void {
		const barAttrs: BarAttrs = {
			x: barAttrsHelper.x(dataRow),
			width: barAttrsHelper.width(dataRow),
	...
	private static renderGroup(
		...
		let group: Selection<SVGGElement, unknown, HTMLElement, unknown> = block.svg
			.getChartBlock()
	...
	private static renderBackground(
		labelsGroup: Selection<SVGGElement, unknown, BaseType, unknown>,
		labelBlock: Selection<SVGTextElement, MdtChartsDataRow, HTMLElement, unknown>,
		attrs: LabelAttrs
	): void {
		labelsGroup
	...
	private static getLabelByIndex(
		labelsSelection: Selection<SVGTextElement, MdtChartsDataRow, SVGGElement, unknown>,
		barIndex: number,
		valueField: Field,
		dataRow: MdtChartsDataRow
