    ...
    describe('getBiggestValueAndDecremented', () => {
        test('should return biggest value by fields if there are not segmented charts', () => {
            ...
            rep.initOptions(
                ...
                [{ format: "money", name: "Val1" }, { format: "money", name: "Val2" }]
            );
            rep.initRawFullSource({ source: [{ Key: "K1", Val1: 100, Val2: 30 }, { Key: "K2", Val1: 120, Val2: 300 }] });
        ...
        test('should return biggest value by segments if there are segmented charts', () => {
            ...
            rep.initOptions(
                ...
                [{ format: "money", name: "Val1" }, { format: "money", name: "Val2" }, { format: "money", name: "Val3" }]
            );
            rep.initRawFullSource({ source: [{ Key: "K1", Val1: 100, Val2: 30, Val3: 30 }, { Key: "K2", Val1: 120, Val2: 300, Val3: 100 }] });
        ...
        test('should return biggest value by segments if there are segmented charts but biggest value in non segmented chart', () => {
            ...
            rep.initRawFullSource({ source: [{ Key: "K1", Val1: 100, Val2: 30, Val3: 500 }, { Key: "K2", Val1: 120, Val2: 300, Val3: 100 }] });
            const result = rep.getBiggestValueAndDecremented([["Val1", "Val2"], ["Val3"]]);
