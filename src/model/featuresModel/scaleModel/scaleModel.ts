...
import { MdtChartsTwoDimensionalChart, MdtChartsTwoDimensionalOptions, MdtChartsDataRow, TwoDimensionalChartType } from "../../../config/config";
...
export class ScaleModel {
    ...
    private getChartsByTypes(charts: MdtChartsTwoDimensionalChart[], types: TwoDimensionalChartType[]): MdtChartsTwoDimensionalChart[] {
