import { TwoDimensionalOptions } from "../config/config";
import { DesignerConfig } from "../designer/designerConfig";
import { GridLineOptions } from "./model";

export class GridLineModel
{
    public static getGridLineOptions(options: TwoDimensionalOptions, designerConfig: DesignerConfig): GridLineOptions {
