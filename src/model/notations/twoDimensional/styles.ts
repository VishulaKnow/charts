...
export function getBarViewOptions(
...
export function getSegmentedRadiusValues(
	...
	else if (segmentIndex === 0) return radiusConfigs.first[keyAxisOrient];
	else if (segmentIndex === segmentsLength - 1) return radiusConfigs.last[keyAxisOrient];
