...
import {
	...
	getLineViewOptions,
	getSegmentedRadiusValues,
	getWidthOfLegendMarkerByType,
	LINE_CHART_DEFAULT_WIDTH,
	parseDashStyles
} from "../../model/notations/twoDimensional/styles";
		...
		dataRows = [
			{
				...
				count: 10000,
				color: "red",
				$mdtChartsMetadata: { valueFieldName: "price" }
			},
			{
				$id: 2,
				brand: "LADA",
		...
		charts = [
			{
				...
				areaViewOptions: {
					fill: {
						type: "gradient",
						ids: ["gradient-chart-1-sub-0", "gradient-chart-1-sub-1"]
					},
					borderLine: {
						on: true,
						colorStyle: {
