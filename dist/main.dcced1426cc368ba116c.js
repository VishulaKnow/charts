...
eval("\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.Chart = void 0;\r\nvar engine_1 = __webpack_require__(/*! ./engine/engine */ \"./src/engine/engine.ts\");\r\nvar modelOptions_1 = __webpack_require__(/*! ./model/modelOptions */ \"./src/model/modelOptions.ts\");\r\nvar Chart = /** @class */ (function () {\r\n    function Chart(config, designerConfig, data) {\r\n        this.config = config;\r\n        this.designerConfig = designerConfig;\r\n        this.data = data;\r\n        this.model = modelOptions_1.assembleModel(this.config, this.data, this.designerConfig);\r\n        this.engine = new engine_1.default();\r\n    }\r\n    Chart.prototype.render = function (parentElement) {\r\n        this.engine.render(this.model, modelOptions_1.getPreparedData(this.model, this.data, this.config), parentElement);\r\n    };\r\n    return Chart;\r\n}());\r\nexports.Chart = Chart;\r\n\n\n//# sourceURL=webpack://mdt-charts/./src/main.ts?");
